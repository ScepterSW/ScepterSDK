...
void ScepterManager::run() 
{
    ...
    this->depthCloudPointPub_ = depthCloudPoint_nh_.advertise<sensor_msgs::PointCloud2>("depthCloudPoint",30);
    this->depth2colorCloudPointPub_ = depth2colorCloudPoint_nh_.advertise<sensor_msgs::PointCloud2>("depth2colorCloudPoint",30);
