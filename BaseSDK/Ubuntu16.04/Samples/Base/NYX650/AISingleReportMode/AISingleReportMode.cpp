...
ScStatus SetParams(ScDeviceHandle deviceHandle)
{
	...
	status = scAIModuleSetWorkMode(deviceHandle, AI_SINGLE_REPORT_MODE);
	if (status == ScStatus::SC_OK)
	{
		cout << "[scAIModuleSetWorkMode] success, ScStatus(" << status << "). Set AI_SINGLE_REPORT_MODE." << endl;
	}
	else
	{
