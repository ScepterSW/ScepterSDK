...
int displayKeyconfiguration(const ScDeviceHandle deviceHandle)
{
	...
	cout << "********scAIModuleGetInputFrameTypeEnabled SC_DEPTH_FRAME :" << enable <<"********"<< endl;
	...
	cout << "********scAIModuleGetInputFrameTypeEnabled SC_IR_FRAME :" << enable <<"********"<< endl;
	int frameRate = 0;
