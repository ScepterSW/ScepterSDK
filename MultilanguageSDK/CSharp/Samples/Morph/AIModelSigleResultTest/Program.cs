...
namespace DeviceSWTriggerMode
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("---AIModelSigleResultTest---");
            ...
            try
            {
                using (StreamWriter sWriter = new StreamWriter("AIModelSigleResultTest.csv"))
                {
                    sWriter.Close();
                }
            }
            ...
            StreamWriter csvWriter = new StreamWriter("AIModelSigleResultTest.csv");
