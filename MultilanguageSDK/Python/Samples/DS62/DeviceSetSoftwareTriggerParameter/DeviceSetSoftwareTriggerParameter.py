...
import time
print('---DeviceSetSoftwareTriggerParameter---')
...
ret = camera.scSetSoftwareTriggerParameter(5)
if ret == 0:
    print('[scSetSoftwareTriggerParameter] success ScStatus({}).  Set the device software trigger parameter to 5.'.format(str(ret)))
else:
    print("scSetSoftwareTriggerParameter failed:" + str(ret))
    exit(1)
