...
if  ret == 0:
    ...
    exit(1)
curPath = os.getcwd()
filename = curPath + "/AIModelSingleResultTest.csv"
try:
...
for i in range(ResultCount):
    ...
    if result.resultIndex % 10 == 0:
        print('[scAIModuleGetResult] ScStatus({}). resultIndex : {} resultTimestamp: {}'.format(str(ret), str(result.resultIndex), str(result.resultTimestamp)))
