...
import time
print("---AISingleReportMode---")
camera = ScepterTofCam()

def setParameters():
    # Set AI module continuous running.
    ret = camera.scAIModuleSetWorkMode(ScAIModuleMode.AI_SINGLE_REPORT_MODE)
    if ret == 0:
        print("[scAIModuleSetWorkMode] success, ScStatus({}). Set AI_SINGLE_REPORT_MODE.".format(ret))
    else:
